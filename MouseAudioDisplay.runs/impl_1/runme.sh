...
HD_PWD='C:/Users/eugen/OneDrive - National University of Singapore/Y2S2/EE2026/Project/MouseAudioDisplay.xpr/MouseAudioDisplay/MouseAudioDisplay.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log movingblocks.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source movingblocks.tcl -notrace
