...
#	set_property IOSTANDARD LVCMOS33 [get_ports {sclk}]
###Sch name = JA7
#set_property PACKAGE_PIN H1 [get_ports {d_cn}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {d_cn}]
###Sch name = JA8
#set_property PACKAGE_PIN K2 [get_ports {resn}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {resn}]
###Sch name = JA9
#set_property PACKAGE_PIN H2 [get_ports {vccen}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {vccen}]
###Sch name = JA10
#set_property PACKAGE_PIN G3 [get_ports {pmoden}]					
